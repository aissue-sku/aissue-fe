...
const SplashPage = () => {
  ...
  return (
    <div className="min-h-dvh bg-white flex flex-col items-center justify-center relative overflow-hidden">
      {/* 떠다니는 장식 원 */}
      <div className="absolute top-[18%] left-[14%] w-3 h-3 rounded-full bg-[#C8E4FF] animate-splash-float-1" />
      <div className="absolute top-[28%] right-[16%] w-2 h-2 rounded-full bg-[#5b9cf6] animate-splash-float-2" />
      <div className="absolute top-[42%] left-[8%]  w-4 h-4 rounded-full bg-[#C8E4FF] animate-splash-float-3" />
      <div className="absolute bottom-[28%] right-[12%] w-3 h-3 rounded-full bg-[#5b9cf6]/40 animate-splash-float-4" />
      <div className="absolute bottom-[20%] left-[18%] w-2 h-2 rounded-full bg-[#C8E4FF] animate-splash-float-2" />
